...
class AppointementRejected extends Component<{}, {value:object}>{
    ...
    {   
       ...
       {
        arr.push(<div style={{borderStyle:"solid",marginBottom:"0.5%",overflowX:"auto",textAlign:"left",margin:"2%",width:"100%"}}>
        ...
        <p id={"Reason"+data.id}>Reason: {data.get("reason")}</p>
        <br></br>
        <br></br>
        </div>
        );
    ...
    async Reuests()
    {
     ...
     var dataquery= await query(collection(db, "appointementRejected"));
  ...
  render(): React.ReactNode {
    ...
    return( 
    <div id="userrejected" style={{height:"100%",overflowX:"hidden",width:"100%",overflowY:"auto",backgroundImage:"linear-gradient(45deg,#efecece1,#ebb1d6bd)"}}>
...
export default AppointementRejected;
