...
class AppointementServiceCheckBox extends Component<{}, {value:object}>{
    ...
    {   
        arr.push(<div >
            ...
            <label style={{textAlign:"justify"}}>id: {i} name: {serviceCollection[count++]}
            </label></div>
        );
  ...
  render(): React.ReactNode {
    ...
    return( <div style={{textAlign:"right"}}><div  id="serplaceHolder" style={{position:"static",float:"left"}}  >
        
   
    </div>

    <div style={{ position:"static",textAlign:"left",float:"right", width:"450px",height:"140px",overflowY:"auto"}}>
    {this.state.value as any}
    </div></div>);
    
}
}
export default AppointementServiceCheckBox;
